...
module.exports = {
  meta: {
    ...
    messages: {
      inlineTabsArray:
        "Inline `const TABS = [...]` in admin page — extract to <section>-tabs.ts and import (Rule G: Tab 1 owns shared tab constants).",
      redeclaredTopLevelTab:
        "Redeclared `type TopLevelTab` — canonical type lives in <section>-tabs.ts (Rule G).",
      siblingTabsImport:
        "Importing TABS from './page' violates Rule G — import from './<section>-tabs' instead (canonical tabs module).",
    },
  },
