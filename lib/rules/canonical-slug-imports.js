...
module.exports = {
  meta: {
    ...
    messages: {
      hardcodedSlugArray:
        "Hardcoded canonical slug array — import {{name}} from '@rello-platform/slugs' instead. Suppress only with: // rello-platform-lint-disable-next-line: canonical-slug-imports -- <reason>",
      hardcodedSlugArrayAnonymous:
        "Hardcoded canonical slug array (≥2 canonical slug literals adjacent) — import APP_SLUGS / ENGINE_SLUGS / PLATFORM_SLUGS from '@rello-platform/slugs' instead. Suppress only with: // rello-platform-lint-disable-next-line: canonical-slug-imports -- <reason>",
    },
  },
