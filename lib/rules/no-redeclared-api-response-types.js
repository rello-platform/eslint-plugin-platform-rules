...
module.exports = {
  meta: {
    ...
    messages: {
      redeclaredResponse:
        "Consumer-side `interface {{name}}` redeclares an api response type — import from the canonical api route file (Rule E). Field-name drift between consumer + route silently NaNs.",
    },
  },
