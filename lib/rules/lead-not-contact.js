...
module.exports = {
  meta: {
    ...
    messages: {
      contactIdentifier:
        "Identifier `{{name}}` matches Contact-shape — use Lead-shape (CLAUDE.md §Core principles: code refs use `lead`; UI text fine). Suppress only with: // rello-platform-lint-disable-next-line: lead-not-contact -- <e.g., third-party API field name>",
    },
  },
